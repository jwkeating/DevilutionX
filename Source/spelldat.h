...
#define JWK_EDIT_LIFE_STEAL_CROWN 1 // If true, buff life steal crown by a small amount
...
#define JWK_EDIT_FLASH 1 // Remove the player-invincibility aspect of flash because it stuns the player in a buggy way.  Without the invincibility flag, flash becomes spammable which feels better.
...
#define JWK_EDIT_BLOOD_STAR 1 // Reduce health consumed as skill level improves
